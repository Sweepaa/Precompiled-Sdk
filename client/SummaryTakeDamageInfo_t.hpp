...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CTakeDamageResult result; // 0xc0        
    ...
    static_assert(offsetof(SummaryTakeDamageInfo_t, result) == 0xc0);
    static_assert(offsetof(SummaryTakeDamageInfo_t, hTarget) == 0xe0);
    
    static_assert(sizeof(SummaryTakeDamageInfo_t) == 0xe8);
};
