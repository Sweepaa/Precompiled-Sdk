...
namespace source2sdk::client
{
    ...
    public:
        ...
        uint32_t m_eNetworkDisconnectionReason; // 0x7ec        
        bool m_bCannotBeKicked; // 0x7f0        
        bool m_bEverFullyConnected; // 0x7f1        
        bool m_bAbandonAllowsSurrender; // 0x7f2        
        bool m_bAbandonOffersInstantSurrender; // 0x7f3        
        bool m_bDisconnection1MinWarningPrinted; // 0x7f4        
        bool m_bScoreReported; // 0x7f5        
        [[maybe_unused]] std::uint8_t pad_0x7f6[0x2]; // 0x7f6
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerExclusive"
        int32_t m_nDisconnectionTick; // 0x7f8        
        [[maybe_unused]] std::uint8_t pad_0x7fc[0xc]; // 0x7fc
        // metadata: MNetworkEnable
        bool m_bControllingBot; // 0x808        
        // metadata: MNetworkEnable
        bool m_bHasControlledBotThisRound; // 0x809        
        bool m_bHasBeenControlledByPlayerThisRound; // 0x80a        
        [[maybe_unused]] std::uint8_t pad_0x80b[0x1]; // 0x80b
        int32_t m_nBotsControlledThisRound; // 0x80c        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerExclusive"
        bool m_bCanControlObservedBot; // 0x810        
        ...
        char m_hObserverPawn[0x4]; // 0x818        
        // metadata: MNetworkEnable
        bool m_bPawnIsAlive; // 0x81c        
        [[maybe_unused]] std::uint8_t pad_0x81d[0x3]; // 0x81d
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
        uint32_t m_iPawnHealth; // 0x820        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
        int32_t m_iPawnArmor; // 0x824        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
        bool m_bPawnHasDefuser; // 0x828        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
        bool m_bPawnHasHelmet; // 0x829        
        // metadata: MNetworkEnable
        uint16_t m_nPawnCharacterDefIndex; // 0x82a        
        // metadata: MNetworkEnable
        int32_t m_iPawnLifetimeStart; // 0x82c        
        // metadata: MNetworkEnable
        int32_t m_iPawnLifetimeEnd; // 0x830        
        // metadata: MNetworkEnable
        int32_t m_iPawnBotDifficulty; // 0x834        
        // metadata: MNetworkEnable
        ...
        char m_hOriginalControllerOfCurrentPawn[0x4]; // 0x838        
        // metadata: MNetworkEnable
        int32_t m_iScore; // 0x83c        
        // metadata: MNetworkEnable
        uint8_t m_recentKillQueue[8]; // 0x840        
        // metadata: MNetworkEnable
        uint8_t m_nFirstKill; // 0x848        
        // metadata: MNetworkEnable
        uint8_t m_nKillCount; // 0x849        
        // metadata: MNetworkEnable
        bool m_bMvpNoMusic; // 0x84a        
        [[maybe_unused]] std::uint8_t pad_0x84b[0x1]; // 0x84b
        // metadata: MNetworkEnable
        int32_t m_eMvpReason; // 0x84c        
        // metadata: MNetworkEnable
        int32_t m_iMusicKitID; // 0x850        
        // metadata: MNetworkEnable
        int32_t m_iMusicKitMVPs; // 0x854        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnMVPCountChanged"
        int32_t m_iMVPs; // 0x858        
        bool m_bIsPlayerNameDirty; // 0x85c        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerExclusive"
        bool m_bFireBulletsSeedSynchronized; // 0x85d        
        [[maybe_unused]] std::uint8_t pad_0x85e[0x2];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCSPlayerController because it is not a standard-layout class
    static_assert(sizeof(CCSPlayerController) == 0x860);
};
