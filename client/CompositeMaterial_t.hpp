...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x68[0x18]; // 0x68
    ...
    static_assert(offsetof(CompositeMaterial_t, m_vecGeneratedTextures) == 0x80);
    
    static_assert(sizeof(CompositeMaterial_t) == 0xa0);
};
