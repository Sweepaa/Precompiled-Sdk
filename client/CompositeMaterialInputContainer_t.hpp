...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CompositeMaterialInputContainerSourceType_t m_nCompositeMaterialInputContainerSourceType; // 0x4        
        ...
        // CUtlVector<client::CompositeMaterialInputLooseVariable_t> m_vecLooseVariables;
        ...
        [[maybe_unused]] std::uint8_t pad_0x119[0x1f];
    };
    #pragma pack(pop)
    
    static_assert(offsetof(CompositeMaterialInputContainer_t, m_bEnabled) == 0x0);
    static_assert(offsetof(CompositeMaterialInputContainer_t, m_nCompositeMaterialInputContainerSourceType) == 0x4);
    static_assert(offsetof(CompositeMaterialInputContainer_t, m_strSpecificContainerMaterial) == 0x8);
    static_assert(offsetof(CompositeMaterialInputContainer_t, m_strAttrName) == 0xe8);
    static_assert(offsetof(CompositeMaterialInputContainer_t, m_strAlias) == 0xf0);
    static_assert(offsetof(CompositeMaterialInputContainer_t, m_vecLooseVariables) == 0xf8);
    static_assert(offsetof(CompositeMaterialInputContainer_t, m_strAttrNameForVar) == 0x110);
    static_assert(offsetof(CompositeMaterialInputContainer_t, m_bExposeExternally) == 0x118);
    
    static_assert(sizeof(CompositeMaterialInputContainer_t) == 0x138);
};
