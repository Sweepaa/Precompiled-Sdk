...
namespace source2sdk::client
{
    ...
    public:
        ...
        // metadata: MNetworkEnable
        entity2::GameTime_t m_fWarmupPeriodEnd; // 0x44        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_fWarmupPeriodStart; // 0x48        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        entity2::GameTime_t m_fRoundStartTime; // 0x6c        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flRestartRoundTime; // 0x70        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flCMMItemDropRevealStartTime; // 0x8b8        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flCMMItemDropRevealEndTime; // 0x8bc        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flNextRespawnWave[32]; // 0xb9c        
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0xc59[0x7]; // 0xc59
        uint64_t m_ullLocalMatchID; // 0xc60        
        // metadata: MNetworkEnable
        int32_t m_nEndMatchMapGroupVoteTypes[10]; // 0xc68        
        // metadata: MNetworkEnable
        int32_t m_nEndMatchMapGroupVoteOptions[10]; // 0xc90        
        // metadata: MNetworkEnable
        int32_t m_nEndMatchMapVoteWinner; // 0xcb8        
        // metadata: MNetworkEnable
        int32_t m_iNumConsecutiveCTLoses; // 0xcbc        
        // metadata: MNetworkEnable
        int32_t m_iNumConsecutiveTerroristLoses; // 0xcc0        
        [[maybe_unused]] std::uint8_t pad_0xcc4[0x1c]; // 0xcc4
        bool m_bMarkClientStopRecordAtRoundEnd; // 0xce0        
        [[maybe_unused]] std::uint8_t pad_0xce1[0xa7]; // 0xce1
        // metadata: MNetworkEnable
        int32_t m_nMatchAbortedEarlyReason; // 0xd88        
        bool m_bHasTriggeredRoundStartMusic; // 0xd8c        
        bool m_bSwitchingTeamsAtRoundReset; // 0xd8d        
        [[maybe_unused]] std::uint8_t pad_0xd8e[0x1a]; // 0xd8e
        // metadata: MNetworkEnable
        // metadata: MNetworkPolymorphic
        client::CCSGameModeRules* m_pGameModeRules; // 0xda8        
        // metadata: MNetworkEnable
        client::C_RetakeGameRules m_RetakeRules; // 0xdb0        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnMatchEndCountChanged"
        uint8_t m_nMatchEndCount; // 0xec8        
        [[maybe_unused]] std::uint8_t pad_0xec9[0x3]; // 0xec9
        // metadata: MNetworkEnable
        int32_t m_nTTeamIntroVariant; // 0xecc        
        // metadata: MNetworkEnable
        int32_t m_nCTTeamIntroVariant; // 0xed0        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnTeamIntroPeriodChanged"
        bool m_bTeamIntroPeriod; // 0xed4        
        [[maybe_unused]] std::uint8_t pad_0xed5[0x3]; // 0xed5
        // metadata: MNetworkEnable
        int32_t m_iRoundEndWinnerTeam; // 0xed8        
        // metadata: MNetworkEnable
        int32_t m_eRoundEndReason; // 0xedc        
        // metadata: MNetworkEnable
        bool m_bRoundEndShowTimerDefend; // 0xee0        
        [[maybe_unused]] std::uint8_t pad_0xee1[0x3]; // 0xee1
        // metadata: MNetworkEnable
        int32_t m_iRoundEndTimerTime; // 0xee4        
        // metadata: MNetworkEnable
        CUtlString m_sRoundEndFunFactToken; // 0xee8        
        // metadata: MNetworkEnable
        CPlayerSlot m_iRoundEndFunFactPlayerSlot; // 0xef0        
        // metadata: MNetworkEnable
        int32_t m_iRoundEndFunFactData1; // 0xef4        
        // metadata: MNetworkEnable
        int32_t m_iRoundEndFunFactData2; // 0xef8        
        // metadata: MNetworkEnable
        int32_t m_iRoundEndFunFactData3; // 0xefc        
        // metadata: MNetworkEnable
        CUtlString m_sRoundEndMessage; // 0xf00        
        // metadata: MNetworkEnable
        int32_t m_iRoundEndPlayerCount; // 0xf08        
        // metadata: MNetworkEnable
        bool m_bRoundEndNoMusic; // 0xf0c        
        [[maybe_unused]] std::uint8_t pad_0xf0d[0x3]; // 0xf0d
        // metadata: MNetworkEnable
        int32_t m_iRoundEndLegacy; // 0xf10        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnRoundEndCountChanged"
        uint8_t m_nRoundEndCount; // 0xf14        
        [[maybe_unused]] std::uint8_t pad_0xf15[0x3]; // 0xf15
        // metadata: MNetworkEnable
        int32_t m_iRoundStartRoundNumber; // 0xf18        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnRoundStartCountChanged"
        uint8_t m_nRoundStartCount; // 0xf1c        
        [[maybe_unused]] std::uint8_t pad_0xf1d[0x400b]; // 0xf1d
        double m_flLastPerfSampleTime; // 0x4f28        
        [[maybe_unused]] std::uint8_t pad_0x4f30[0x4008];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_CSGameRules because it is not a standard-layout class
    static_assert(sizeof(C_CSGameRules) == 0x8f38);
};
