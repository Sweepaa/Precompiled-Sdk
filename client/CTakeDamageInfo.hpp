...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x98[0x14]; // 0x98
        bool m_bInTakeDamageFlow; // 0xac        
        [[maybe_unused]] std::uint8_t pad_0xad[0xb];
    ...
    static_assert(offsetof(CTakeDamageInfo, m_nNumObjectsPenetrated) == 0x88);
    static_assert(offsetof(CTakeDamageInfo, m_flFriendlyFireDamageReductionRatio) == 0x8c);
    static_assert(offsetof(CTakeDamageInfo, m_hScriptInstance) == 0x90);
    static_assert(offsetof(CTakeDamageInfo, m_bInTakeDamageFlow) == 0xac);
    
    static_assert(sizeof(CTakeDamageInfo) == 0xb8);
};
