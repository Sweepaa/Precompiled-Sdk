...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CPlayer_WeaponServices* m_pWeaponServices; // 0x11a8        
        // metadata: MNetworkEnable
        client::CPlayer_ItemServices* m_pItemServices; // 0x11b0        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerExclusive"
        client::CPlayer_AutoaimServices* m_pAutoaimServices; // 0x11b8        
        // metadata: MNetworkEnable
        client::CPlayer_ObserverServices* m_pObserverServices; // 0x11c0        
        // metadata: MNetworkEnable
        client::CPlayer_WaterServices* m_pWaterServices; // 0x11c8        
        // metadata: MNetworkEnable
        client::CPlayer_UseServices* m_pUseServices; // 0x11d0        
        // metadata: MNetworkEnable
        client::CPlayer_FlashlightServices* m_pFlashlightServices; // 0x11d8        
        // metadata: MNetworkEnable
        client::CPlayer_CameraServices* m_pCameraServices; // 0x11e0        
        // metadata: MNetworkEnable
        client::CPlayer_MovementServices* m_pMovementServices; // 0x11e8        
        [[maybe_unused]] std::uint8_t pad_0x11f0[0x8]; // 0x11f0
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerExclusive"
        ...
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerExclusive"
        client::sky3dparams_t m_skybox3d; // 0x1268        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flDeathTime; // 0x12f8        
        Vector m_vecPredictionError; // 0x12fc        
        entity2::GameTime_t m_flPredictionErrorTime; // 0x1308        
        Vector m_vecLastCameraSetupLocalOrigin; // 0x130c        
        entity2::GameTime_t m_flLastCameraSetupTime; // 0x1318        
    ...
    static_assert(sizeof(C_BasePlayerPawn) == 0x1348);
};
