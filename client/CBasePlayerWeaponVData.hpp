...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::ItemFlagTypes_t m_iFlags; // 0x2f1        
        ...
        client::AmmoIndex_t m_nPrimaryAmmoType; // 0x2f2        
        // metadata: MPropertyAttributeEditor "VDataChoice( scripts/ammo.vdata )"
        // metadata: MPropertyCustomFGDType "string"
        client::AmmoIndex_t m_nSecondaryAmmoType; // 0x2f3        
        ...
        [[maybe_unused]] std::uint8_t pad_0x305[0x3]; // 0x305
        ...
        [[maybe_unused]] std::uint8_t pad_0x30e[0x2]; // 0x30e
        client::RumbleEffect_t m_iRumbleEffect; // 0x310        
    ...
    static_assert(sizeof(CBasePlayerWeaponVData) == 0x348);
};
