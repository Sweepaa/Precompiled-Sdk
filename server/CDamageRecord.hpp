...
namespace source2sdk::server
{
    ...
    public:
        ...
        // CHandle<server::CCSPlayerPawn> m_PlayerDamager;
        ...
        // CHandle<server::CCSPlayerPawn> m_PlayerRecipient;
        ...
        // CHandle<server::CCSPlayerController> m_hPlayerControllerDamager;
        ...
        // CHandle<server::CCSPlayerController> m_hPlayerControllerRecipient;
        ...
        // metadata: MNetworkEnable
        client::EKillTypes_t m_killType; // 0x6d        
    ...
    static_assert(offsetof(CDamageRecord, m_iBulletsDamage) == 0x58);
    static_assert(offsetof(CDamageRecord, m_iDamage) == 0x5c);
    static_assert(offsetof(CDamageRecord, m_iActualHealthRemoved) == 0x60);
    static_assert(offsetof(CDamageRecord, m_iNumHits) == 0x64);
    static_assert(offsetof(CDamageRecord, m_iLastBulletUpdate) == 0x68);
    static_assert(offsetof(CDamageRecord, m_bIsOtherEnemy) == 0x6c);
    static_assert(offsetof(CDamageRecord, m_killType) == 0x6d);
