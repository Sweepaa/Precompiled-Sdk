...
namespace source2sdk::server
{
    ...
    public:
        ...
        uint32_t m_eNetworkDisconnectionReason; // 0x874        
        bool m_bCannotBeKicked; // 0x878        
        bool m_bEverFullyConnected; // 0x879        
        bool m_bAbandonAllowsSurrender; // 0x87a        
        bool m_bAbandonOffersInstantSurrender; // 0x87b        
        bool m_bDisconnection1MinWarningPrinted; // 0x87c        
        bool m_bScoreReported; // 0x87d        
        [[maybe_unused]] std::uint8_t pad_0x87e[0x2]; // 0x87e
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerExclusive"
        int32_t m_nDisconnectionTick; // 0x880        
        [[maybe_unused]] std::uint8_t pad_0x884[0xc]; // 0x884
        // metadata: MNetworkEnable
        bool m_bControllingBot; // 0x890        
        // metadata: MNetworkEnable
        bool m_bHasControlledBotThisRound; // 0x891        
        bool m_bHasBeenControlledByPlayerThisRound; // 0x892        
        [[maybe_unused]] std::uint8_t pad_0x893[0x1]; // 0x893
        int32_t m_nBotsControlledThisRound; // 0x894        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerExclusive"
        bool m_bCanControlObservedBot; // 0x898        
        ...
        char m_hObserverPawn[0x4]; // 0x8a0        
        int32_t m_DesiredObserverMode; // 0x8a4        
        CEntityHandle m_hDesiredObserverTarget; // 0x8a8        
        // metadata: MNetworkEnable
        bool m_bPawnIsAlive; // 0x8ac        
        [[maybe_unused]] std::uint8_t pad_0x8ad[0x3]; // 0x8ad
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
        uint32_t m_iPawnHealth; // 0x8b0        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
        int32_t m_iPawnArmor; // 0x8b4        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
        bool m_bPawnHasDefuser; // 0x8b8        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
        bool m_bPawnHasHelmet; // 0x8b9        
        // metadata: MNetworkEnable
        uint16_t m_nPawnCharacterDefIndex; // 0x8ba        
        // metadata: MNetworkEnable
        int32_t m_iPawnLifetimeStart; // 0x8bc        
        // metadata: MNetworkEnable
        int32_t m_iPawnLifetimeEnd; // 0x8c0        
        // metadata: MNetworkEnable
        int32_t m_iPawnBotDifficulty; // 0x8c4        
        // metadata: MNetworkEnable
        ...
        char m_hOriginalControllerOfCurrentPawn[0x4]; // 0x8c8        
        // metadata: MNetworkEnable
        int32_t m_iScore; // 0x8cc        
        int32_t m_iRoundScore; // 0x8d0        
        int32_t m_iRoundsWon; // 0x8d4        
        // metadata: MNetworkEnable
        uint8_t m_recentKillQueue[8]; // 0x8d8        
        // metadata: MNetworkEnable
        uint8_t m_nFirstKill; // 0x8e0        
        // metadata: MNetworkEnable
        uint8_t m_nKillCount; // 0x8e1        
        // metadata: MNetworkEnable
        bool m_bMvpNoMusic; // 0x8e2        
        [[maybe_unused]] std::uint8_t pad_0x8e3[0x1]; // 0x8e3
        // metadata: MNetworkEnable
        int32_t m_eMvpReason; // 0x8e4        
        // metadata: MNetworkEnable
        int32_t m_iMusicKitID; // 0x8e8        
        // metadata: MNetworkEnable
        int32_t m_iMusicKitMVPs; // 0x8ec        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnMVPCountChanged"
        int32_t m_iMVPs; // 0x8f0        
        int32_t m_nUpdateCounter; // 0x8f4        
        float m_flSmoothedPing; // 0x8f8        
        [[maybe_unused]] std::uint8_t pad_0x8fc[0xf0a4]; // 0x8fc
        server::IntervalTimer m_lastHeldVoteTimer; // 0xf9a0        
        [[maybe_unused]] std::uint8_t pad_0xf9b0[0x8]; // 0xf9b0
        bool m_bShowHints; // 0xf9b8        
        [[maybe_unused]] std::uint8_t pad_0xf9b9[0x3]; // 0xf9b9
        int32_t m_iNextTimeCheck; // 0xf9bc        
        bool m_bJustDidTeamKill; // 0xf9c0        
        bool m_bPunishForTeamKill; // 0xf9c1        
        bool m_bGaveTeamDamageWarning; // 0xf9c2        
        bool m_bGaveTeamDamageWarningThisRound; // 0xf9c3        
        [[maybe_unused]] std::uint8_t pad_0xf9c4[0x4]; // 0xf9c4
        double m_dblLastReceivedPacketPlatFloatTime; // 0xf9c8        
        entity2::GameTime_t m_LastTeamDamageWarningTime; // 0xf9d0        
        entity2::GameTime_t m_LastTimePlayerWasDisconnectedForPawnsRemove; // 0xf9d4        
        uint32_t m_nSuspiciousHitCount; // 0xf9d8        
        uint32_t m_nNonSuspiciousHitStreak; // 0xf9dc        
        [[maybe_unused]] std::uint8_t pad_0xf9e0[0xa1]; // 0xf9e0
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerExclusive"
        bool m_bFireBulletsSeedSynchronized; // 0xfa81        
        [[maybe_unused]] std::uint8_t pad_0xfa82[0x6];
    ...
    static_assert(sizeof(CCSPlayerController) == 0xfa88);
};
