...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_flFireTime; // 0x798        
        ...
        // metadata: MNetworkEnable
        client::BeamType_t m_nBeamType; // 0x7b8        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        modellib::AttachmentHandle_t m_nAttachIndex[10]; // 0x7e8        
        ...
        // metadata: MNetworkEnable
        client::BeamClipStyle_t m_nClipStyle; // 0x814        
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(CBeam) == 0x830);
};
