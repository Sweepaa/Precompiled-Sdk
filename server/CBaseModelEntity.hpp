...
namespace source2sdk::server
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x528[0x28]; // 0x528
        client::HitGroup_t m_LastHitGroup; // 0x550        
        entity2::GameTime_t m_flDissolveStartTime; // 0x554        
        entity2::CEntityIOOutput m_OnIgnite; // 0x558        
        // metadata: MNetworkEnable
        client::RenderMode_t m_nRenderMode; // 0x580        
        // metadata: MNetworkEnable
        client::RenderFx_t m_nRenderFX; // 0x581        
        bool m_bAllowFadeInView; // 0x582        
        [[maybe_unused]] std::uint8_t pad_0x583[0x1d]; // 0x583
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0x5fa[0x6]; // 0x5fa
        // metadata: MNetworkEnable
        server::CCollisionProperty m_Collision; // 0x600        
        // metadata: MNetworkEnable
        server::CGlowProperty m_Glow; // 0x6b0        
        // metadata: MNetworkEnable
        ...
        client::CNetworkViewOffsetVector m_vecViewOffset; // 0x760        
    ...
    static_assert(sizeof(CBaseModelEntity) == 0x790);
};
