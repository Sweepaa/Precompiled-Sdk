...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_areaEnteredTimestamp; // 0x5614        
        ...
        entity2::GameTime_t m_targetSpotTime; // 0x60e0        
        float m_aimFocus; // 0x60e4        
        float m_aimFocusInterval; // 0x60e8        
        entity2::GameTime_t m_aimFocusNextUpdate; // 0x60ec        
        ...
        entity2::GameTime_t m_fireWeaponTimestamp; // 0x63b0        
        ...
        entity2::GameTime_t m_stuckTimestamp; // 0x6494        
        ...
        entity2::GameTime_t m_nextCleanupCheckTimestamp; // 0x64d8        
