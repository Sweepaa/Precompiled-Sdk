...
namespace source2sdk::server
{
    ...
    public:
        ...
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "RenderingChanged"
        entity2::GameTime_t m_flLightStyleStartTime; // 0x7c8        
        ...
        entity2::CEntityIOOutput m_StyleEvent[4]; // 0x818        
        [[maybe_unused]] std::uint8_t pad_0x8b8[0x20]; // 0x8b8
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "RenderingChanged"
    ...
    static_assert(sizeof(CBarnLight) == 0xab0);
};
