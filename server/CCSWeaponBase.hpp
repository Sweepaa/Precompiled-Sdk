...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t m_nLastEmptySoundCmdNum; // 0xe1c        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalWeaponExclusive"
        uint32_t m_nViewModelIndex; // 0xe20        
        bool m_bReloadsWithClips; // 0xe24        
        [[maybe_unused]] std::uint8_t pad_0xe25[0x1b]; // 0xe25
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalWeaponExclusive"
        // metadata: MNetworkPriority "32"
        entity2::GameTime_t m_flTimeWeaponIdle; // 0xe40        
        bool m_bFireOnEmpty; // 0xe44        
        [[maybe_unused]] std::uint8_t pad_0xe45[0x3]; // 0xe45
        entity2::CEntityIOOutput m_OnPlayerPickup; // 0xe48        
        // metadata: MNetworkEnable
        client::CSWeaponMode m_weaponMode; // 0xe70        
        ...
        entity2::GameTime_t m_flLastAccuracyUpdateTime; // 0xe8c        
        float m_fAccuracySmoothedForZoom; // 0xe90        
        entity2::GameTime_t m_fScopeZoomEndTime; // 0xe94        
        // metadata: MNetworkEnable
        int32_t m_iRecoilIndex; // 0xe98        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        entity2::GameTick_t m_nPostponeFireReadyTicks; // 0xea4        
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0xeae[0x2]; // 0xeae
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flDroppedAtTime; // 0xeb0        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flTimeSilencerSwitchComplete; // 0xeb8        
        // metadata: MNetworkEnable
        int32_t m_iOriginalTeamNumber; // 0xebc        
        // metadata: MNetworkEnable
        int32_t m_iMostRecentTeamNumber; // 0xec0        
        // metadata: MNetworkEnable
        bool m_bDroppedNearBuyZone; // 0xec4        
        [[maybe_unused]] std::uint8_t pad_0xec5[0x3]; // 0xec5
        float m_flNextAttackRenderTimeOffset; // 0xec8        
        [[maybe_unused]] std::uint8_t pad_0xecc[0x14]; // 0xecc
        bool m_bCanBePickedUp; // 0xee0        
        bool m_bUseCanOverrideNextOwnerTouchTime; // 0xee1        
        [[maybe_unused]] std::uint8_t pad_0xee2[0x2]; // 0xee2
        entity2::GameTime_t m_nextOwnerTouchTime; // 0xee4        
        entity2::GameTime_t m_nextPrevOwnerTouchTime; // 0xee8        
        [[maybe_unused]] std::uint8_t pad_0xeec[0x4]; // 0xeec
        // metadata: MNetworkEnable
        entity2::GameTime_t m_nextPrevOwnerUseTime; // 0xef0        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        entity2::GameTick_t m_nDropTick; // 0xef8        
        [[maybe_unused]] std::uint8_t pad_0xefc[0x20]; // 0xefc
        bool m_donated; // 0xf1c        
        [[maybe_unused]] std::uint8_t pad_0xf1d[0x3]; // 0xf1d
        // metadata: MNetworkEnable
        entity2::GameTime_t m_fLastShotTime; // 0xf20        
        ...
        server::CIronSightController m_IronSightController; // 0xf30        
        // metadata: MNetworkEnable
        int32_t m_iIronSightMode; // 0xf48        
        entity2::GameTime_t m_flLastLOSTraceFailureTime; // 0xf4c        
        // metadata: MNetworkEnable
        int32_t m_iNumEmptyAttacks; // 0xf50        
        float m_flWatTickOffset; // 0xf54        
        [[maybe_unused]] std::uint8_t pad_0xf58[0x10];
    ...
    static_assert(sizeof(CCSWeaponBase) == 0xf68);
};
