...
namespace source2sdk::server
{
    ...
    public:
        ...
        // metadata: MNetworkEnable
        modellib::AttachmentHandle_t m_nAttachment; // 0x79c        
        ...
        entity2::GameTime_t m_flDieTime; // 0x7a8        
        [[maybe_unused]] std::uint8_t pad_0x7ac[0xc]; // 0x7ac
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(CSprite) == 0x800);
};
